/**
 * 通过插桩记录方法调用、参数、返回值和副作用，为 isolated validation 生成原始日志。
 */
...
public class LoggingAspect {
    ...
    @Pointcut("execution(* org.apache.commons.cli..*(..)) && " +
            "!execution(* org.apache.commons.cli..*Test.*(..)) && " +
            "!execution(* org.apache.commons.cli..*TestCase.*(..)) && " +
            "!@annotation(org.junit.Test)")
    public void applicationMethods() {}

    @Pointcut("execution(* org.apache.commons.cli.LoggingAspect.*(..))")
    public void loggingAspectMethods() {}

    @Pointcut("execution(* org.apache.commons.cli.CustomToStringConverter.*(..))")
    public void customToStringConverterMethods() {}

    @Pointcut("execution(org.apache.commons.cli..new(..)) && " +
            "!execution(org.apache.commons.cli.LoggingAspect.new(..)) && " +
            "!execution(org.apache.commons.cli.CustomToStringConverter.new(..)) &&" +
            "!execution(org.apache.commons.cli..*Test.new(..)) && " +
            "!execution(org.apache.commons.cli..*TestCase.new(..))")
    ...
    public Object logMethodVariables(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        for (Class<?> clazz : allClasses) {
            ...
            if (clazz.getName().contains("org.apache.commons.cli") || clazz.getName().startsWith("java.")) {
