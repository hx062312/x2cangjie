...
public class AnsiOutputStream extends FilterOutputStream {
    ...
    @FunctionalInterface
    public interface AnsiOutputStream_IoRunnable {
        void run() throws IOException;
    }

    @FunctionalInterface
    public interface AnsiOutputStream_WidthSupplier {
        int getTerminalWidth();
    }

    public static class AnsiOutputStream_ZeroWidthSupplier implements AnsiOutputStream_WidthSupplier {
        @Override
    ...
    private final AnsiOutputStream_WidthSupplier width;
    private final AnsiProcessor processor;
    private final AnsiType type__;
    private final AnsiColors colors;
    private final AnsiOutputStream_IoRunnable installer;
    private final AnsiOutputStream_IoRunnable uninstaller;
    ...
    public void uninstall() throws IOException {
        if (resetAtUninstall && type__ != AnsiType.Redirected && type__ != AnsiType.Unsupported) {
