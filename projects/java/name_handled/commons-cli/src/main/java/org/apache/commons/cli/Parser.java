...
public abstract class Parser implements CommandLineParser {
     ...
     *     tokens.
     */
    public CommandLine parse0(final Options options_param, final String[] arguments)
            throws ParseException {
        return parse3(options_param, arguments, null, false);
    }
    ...
    public CommandLine parse1(
            final Options options_param, final String[] arguments, final boolean stopAtNonOption)
            throws ParseException {
        return parse3(options_param, arguments, null, stopAtNonOption);
    }
    ...
    public CommandLine parse2(
            final Options options_param, final String[] arguments, final Properties properties)
            throws ParseException {
        return parse3(options_param, arguments, properties, false);
    }
    ...
    public CommandLine parse3(
            final Options options_param,
            String[] arguments,
            final Properties properties,
            final boolean stopAtNonOption)
            throws ParseException {
        for (final Option opt : options_param.helpOptions()) {
            opt.clearValues();
        }

        for (final OptionGroup group : options_param.getOptionGroups()) {
            group.setSelected(null);
        }

        setOptions(options_param);
    ...
    protected void setOptions(final Options options_param) {
        this.options = options_param;
        this.requiredOptions = new ArrayList<>(options_param.getRequiredOptions());
    }
