...
public class Languages {
    ...
    /** A set of languages. */
    public abstract static class Languages_LanguageSet {

        public static Languages_LanguageSet from(final Set<String> langs) {
            return langs.isEmpty() ? NO_LANGUAGES : new Languages_SomeLanguages(langs);
        }
        ...
        public abstract Languages_LanguageSet restrictTo(Languages_LanguageSet other);

        abstract Languages_LanguageSet merge(Languages_LanguageSet other);
    }

    public static class Languages_AnyLanguage extends Languages_LanguageSet {
        public Languages_AnyLanguage() {
            super();
        }
        ...
        public Languages_LanguageSet restrictTo(final Languages_LanguageSet other) {
            return other;
        }

        public Languages_LanguageSet merge(final Languages_LanguageSet other) {
            return other;
        }
    ...
    public static class Languages_NoLanguage extends Languages_LanguageSet {
        public Languages_NoLanguage() {
            super();
        }
    ...
    public static final class Languages_SomeLanguages extends Languages_LanguageSet {
        private final Set<String> languages;

        private Languages_SomeLanguages(final Set<String> languages_param) {
            this.languages = Collections.unmodifiableSet(languages_param);
        }
        ...
        public Languages_LanguageSet restrictTo(final Languages_LanguageSet other) {
            ...
            final Languages_SomeLanguages someLanguages = (Languages_SomeLanguages) other;
    ...
    /** No languages at all. */
    public static final Languages_LanguageSet NO_LANGUAGES = new Languages_NoLanguage();

    /** Any/all languages. */
    public static final Languages_LanguageSet ANY_LANGUAGE = new Languages_AnyLanguage();

    private Languages(final Set<String> languages_param) {
