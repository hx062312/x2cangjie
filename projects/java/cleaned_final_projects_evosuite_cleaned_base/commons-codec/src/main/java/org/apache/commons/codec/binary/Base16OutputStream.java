...
public class Base16OutputStream extends BaseNCodecOutputStream {
    ...
    public Base16OutputStream(
        ...
        super(out, new Base16(lowerCase, decodingPolicy), doEncode_param);
    }

    public static Base16OutputStream Base16OutputStream1(
            final OutputStream out, final boolean doEncode_param, final boolean lowerCase) {
        return new Base16OutputStream(out, doEncode_param, lowerCase, CodecPolicy.LENIENT);
    }

    public static Base16OutputStream Base16OutputStream2(
            final OutputStream out, final boolean doEncode_param) {
        return Base16OutputStream1(out, doEncode_param, false);
    }
