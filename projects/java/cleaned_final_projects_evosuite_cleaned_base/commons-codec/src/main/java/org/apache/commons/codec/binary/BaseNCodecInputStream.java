...
import org.apache.commons.codec.binary.BaseNCodec.BaseNCodec_Context;
...
public class BaseNCodecInputStream extends FilterInputStream {
    ...
    private final BaseNCodec_Context context = new BaseNCodec_Context();

    protected BaseNCodecInputStream(
            final InputStream input, final BaseNCodec baseNCodec_param, final boolean doEncode_param) {
        super(input);
        this.doEncode = doEncode_param;
        this.baseNCodec = baseNCodec_param;
        this.buf = new byte[doEncode_param ? 4096 : 8192];
    }
