...
public class DoubleMetaphone implements StringEncoder {
    ...
    public String doubleMetaphone1(String value, final boolean alternate) {
        ...
        final DoubleMetaphone_DoubleMetaphoneResult result = new DoubleMetaphone_DoubleMetaphoneResult(this.getMaxCodeLen());
     ...
     */
    public void setMaxCodeLen(final int maxCodeLen_param) {
        this.maxCodeLen = maxCodeLen_param;
    }

    /** Handles 'A', 'E', 'I', 'O', 'U', and 'Y' cases. */
    private int handleAEIOUY(final DoubleMetaphone_DoubleMetaphoneResult result, final int index) {
        if (index == 0) {
            result.append0('A');
        }
        return index + 1;
    ...
    /** Handles 'C' cases. */
    private int handleC(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, int index) {
    ...
    /** Handles 'CC' cases. */
    private int handleCC(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, int index) {
    ...
    /** Handles 'CH' cases. */
    private int handleCH(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, final int index) {
    ...
    /** Handles 'D' cases. */
    private int handleD(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, int index) {
    ...
    private int handleG(
            final String value,
            final DoubleMetaphone_DoubleMetaphoneResult result,
            int index,
    ...
    /** Handles 'GH' cases. */
    private int handleGH(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, int index) {
    ...
    /** Handles 'H' cases. */
    private int handleH(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, int index) {
        if ((index == 0 || isVowel(charAt(value, index - 1)))
    ...
    /** Handles 'L' cases. */
    private int handleL(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, int index) {
    ...
    /** Handles 'P' cases. */
    private int handleP(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, int index) {
        if (charAt(value, index + 1) == 'H') {
            result.append0('F');
            index += 2;
        } else {
    ...
    /** Handles 'SC' cases. */
    private int handleSC(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, final int index) {
    ...
    /** Handles 'T' cases. */
    private int handleT(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, int index) {
    ...
    /** Handles 'W' cases. */
    private int handleW(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, int index) {
    ...
    /** Handles 'X' cases. */
    private int handleX(final String value, final DoubleMetaphone_DoubleMetaphoneResult result, int index) {
        if (index == 0) {
            result.append0('S');
            index++;
        } else {
    ...
    public class DoubleMetaphone_DoubleMetaphoneResult {
        ...
        public DoubleMetaphone_DoubleMetaphoneResult(final int maxLength_param) {
            this.maxLength = maxLength_param;
        }
        ...
        public void append1(final char primary_param, final char alternate_param) {
            appendPrimary0(primary_param);
            appendAlternate0(alternate_param);
        }
        ...
        public void append3(final String primary_param, final String alternate_param) {
            appendPrimary1(primary_param);
            appendAlternate1(alternate_param);
        }
