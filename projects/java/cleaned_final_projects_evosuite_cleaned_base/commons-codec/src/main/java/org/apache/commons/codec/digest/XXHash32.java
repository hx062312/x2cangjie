...
public class XXHash32 implements Checksum {
    ...
    public XXHash32(final int seed_param) {
     ...
     */
    private static int getInt(final byte[] buffer_param, final int idx) {
        return ((buffer_param[idx] & 0xff))
                | ((buffer_param[idx + 1] & 0xff) << 8)
                | ((buffer_param[idx + 2] & 0xff) << 16)
                | ((buffer_param[idx + 3] & 0xff) << 24);
    }
