...
public class PercentCodec implements BinaryEncoder, BinaryDecoder {
     ...
     */
    public PercentCodec(
            int constructorId, final boolean plusForSpace_param, final byte[] alwaysEncodeChars_param) {
        if (constructorId == 0) {

            this.plusForSpace = plusForSpace_param;
            insertAlwaysEncodeChars(alwaysEncodeChars_param);
        } else {
