...
public final class MurmurHash3 {
     ...
     * @since 1.14
     */
    public static class MurmurHash3_IncrementalHash32x86 {
         ...
         */
        int finalise(
                final int hash_param,
                final int unprocessedLength_param,
                final byte[] unprocessed_param,
                final int totalLen_param) {
            int result = hash_param;
            int k1 = 0;
            switch (unprocessedLength_param) {
                case 3:
                    k1 ^= (unprocessed_param[2] & 0xff) << 16;
                case 2:
                    k1 ^= (unprocessed_param[1] & 0xff) << 8;
                case 1:
                    k1 ^= (unprocessed_param[0] & 0xff);
     ...
     * <p>
     *
     * @deprecated Use MurmurHash3_IncrementalHash32x86. This corrects the processing of trailing bytes.
     */
    @Deprecated
    public static class MurmurHash3_IncrementalHash32 extends MurmurHash3_IncrementalHash32x86 {
        ...
        int finalise(
            ...
            switch (unprocessedLength_param) {
                case 3:
                    k1 ^= unprocessed_param[2] << 16;
                case 2:
                    k1 ^= unprocessed_param[1] << 8;
                case 1:
                    k1 ^= unprocessed_param[0];
