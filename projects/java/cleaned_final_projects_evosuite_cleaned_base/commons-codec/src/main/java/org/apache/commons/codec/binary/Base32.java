...
public class Base32 extends BaseNCodec {
     ...
     */
    public static Base32 Base323(final byte pad_param) {
        return Base322(false, pad_param);
    }
     ...
     */
    public static Base32 Base324(final int lineLength_param) {
        return Base325(lineLength_param, CHUNK_SEPARATOR);
    }
     ...
     *     characters.
     */
    public static Base32 Base325(final int lineLength_param, final byte[] lineSeparator_param) {
        return Base327(lineLength_param, lineSeparator_param, false, PAD_DEFAULT);
    }
    ...
    public static Base32 Base326(
            final int lineLength_param, final byte[] lineSeparator_param, final boolean useHex) {
        return Base327(lineLength_param, lineSeparator_param, useHex, PAD_DEFAULT);
    }
    ...
    public static Base32 Base327(
            final int lineLength_param,
            final byte[] lineSeparator_param,
            final boolean useHex,
            final byte padding) {
        return new Base32(lineLength_param, lineSeparator_param, useHex, padding, DECODING_POLICY_DEFAULT);
    }
    ...
    public Base32(
            ...
            final boolean useHex,
            final byte padding,
            final CodecPolicy decodingPolicy_param) {
        super(  2,
                BYTES_PER_UNENCODED_BLOCK,
                BYTES_PER_ENCODED_BLOCK,
                lineLength_param,
                lineSeparator_param == null ? 0 : lineSeparator_param.length,
                padding,
                decodingPolicy_param);
        if (useHex) {
        ...
        if (lineLength_param > 0) {
            if (lineSeparator_param == null) {
                throw new IllegalArgumentException(
                        "lineLength " + lineLength_param + " > 0, but lineSeparator is null");
            }
            if (containsAlphabetOrPad(lineSeparator_param)) {
                final String sep = StringUtils.newStringUtf8(lineSeparator_param);
                throw new IllegalArgumentException(
                        "lineSeparator must not contain Base32 characters: [" + sep + "]");
            }
            this.encodeSize = BYTES_PER_ENCODED_BLOCK + lineSeparator_param.length;
            this.lineSeparator = lineSeparator_param.clone();
        } else {
     ...
     *
     * <p>Output is written to {@link org.apache.commons.codec.binary.BaseNCodec.BaseNCodec_Context#buffer
     * BaseNCodec_Context#buffer} as 8-bit octets, using {@link
     * org.apache.commons.codec.binary.BaseNCodec.BaseNCodec_Context#pos BaseNCodec_Context#pos} as the buffer position
     *
     ...
     */
    @Override
    void decode1(final byte[] input, int inPos, final int inAvail, final BaseNCodec_Context context) {
     ...
     */
    @Override
    void encode2(final byte[] input, int inPos, final int inAvail, final BaseNCodec_Context context) {
     ...
     */
    private void validateCharacter(final long emptyBitsMask, final BaseNCodec_Context context) {
