...
public class QuotedPrintableCodec
    ...
    public QuotedPrintableCodec(
            ...
            final Charset charset_param,
            final boolean strict_param) {
        if (constructorId == 1) {

            this.charset = charset_param;
            this.strict = strict_param;
        } else {
    ...
    public static QuotedPrintableCodec QuotedPrintableCodec2(final Charset charset_param) {
        return new QuotedPrintableCodec(1, null, charset_param, false);
    }

    public static QuotedPrintableCodec QuotedPrintableCodec3(final boolean strict_param) {
        return new QuotedPrintableCodec(1, null, StandardCharsets.UTF_8, strict_param);
    }
    ...
    public static final byte[] encodeQuotedPrintable2(
            BitSet printable, final byte[] bytes, final boolean strict_param) {
        if (bytes == null) {
            return null;
        }
        if (printable == null) {
