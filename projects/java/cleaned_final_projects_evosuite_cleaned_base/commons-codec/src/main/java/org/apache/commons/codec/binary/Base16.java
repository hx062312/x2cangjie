...
public class Base16 extends BaseNCodec {
    ...
    public Base16(final boolean lowerCase, final CodecPolicy decodingPolicy_param) {
        super(  2,
     ...
     */
    @Override
    void decode1(final byte[] data, int offset, final int length, final BaseNCodec_Context context) {
    ...
    @Override
    void encode2(final byte[] data, final int offset, final int length, final BaseNCodec_Context context) {
        if (context.eof) {
            return;
        }
