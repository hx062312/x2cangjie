...
public class Base16InputStream extends BaseNCodecInputStream {
    ...
    public Base16InputStream(
            final InputStream in__,
            final boolean doEncode_param,
            final boolean lowerCase,
            final CodecPolicy decodingPolicy) {
        super(in__, new Base16(lowerCase, decodingPolicy), doEncode_param);
    }

    public static Base16InputStream Base16InputStream1(
            final InputStream in__, final boolean doEncode_param, final boolean lowerCase) {
        return new Base16InputStream(in__, doEncode_param, lowerCase, CodecPolicy.LENIENT);
    }

    public static Base16InputStream Base16InputStream2(
            final InputStream in__, final boolean doEncode_param) {
        return Base16InputStream1(in__, doEncode_param, false);
    }

    public static Base16InputStream Base16InputStream3(final InputStream in__) {
        return Base16InputStream2(in__, false);
    }
