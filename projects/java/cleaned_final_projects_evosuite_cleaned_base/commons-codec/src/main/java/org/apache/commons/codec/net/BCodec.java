...
public class BCodec extends RFC1522Codec implements StringEncoder, StringDecoder {
     ...
     * @since 1.7
     */
    public static BCodec BCodec1(final Charset charset_param) {
        return new BCodec(charset_param, DECODING_POLICY_DEFAULT);
    }
     ...
     * @since 1.15
     */
    public BCodec(final Charset charset_param, final CodecPolicy decodingPolicy_param) {
        this.charset = charset_param;
        this.decodingPolicy = decodingPolicy_param;
    }
