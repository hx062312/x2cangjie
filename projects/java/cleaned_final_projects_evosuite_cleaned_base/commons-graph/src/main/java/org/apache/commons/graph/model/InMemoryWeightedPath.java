...
public final class InMemoryWeightedPath<V, WE, W> extends InMemoryPath<V, WE>
    ...
    private static final long serialVersionUID_field = 7937494144459068796L;
    ...
    public InMemoryWeightedPath(
            V start, V target_param, Monoid<W> weightOperations_param, Mapper<WE, W> weightedEdges_param) {
        super(start, target_param);
        this.weightOperations = weightOperations_param;
        this.weightedEdges = weightedEdges_param;

        this.weight = weightOperations_param.identity();
    }
