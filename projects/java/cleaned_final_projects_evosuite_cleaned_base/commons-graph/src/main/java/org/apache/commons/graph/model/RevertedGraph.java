...
public final class RevertedGraph<V, E> implements DirectedGraph<V, E> {
     ...
     */
    public RevertedGraph(DirectedGraph<V, E> directedGraph_param) {
        directedGraph_param = checkNotNull(directedGraph_param, "Adapted DirectedGraph must be not null");
        this.directedGraph = directedGraph_param;
    }
