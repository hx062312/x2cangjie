...
final class DotExporter<V, E> extends AbstractExporter<V, E, DotExporter<V, E>> {
    ...
    DotExporter(Graph<V, E> graph_param, String name_param) {
        super(graph_param, name_param);
        this.vertexIdentifiers = generateVertexIdentifiers(graph_param);
    }
    ...
    @Override
    protected void enlistEdgesProperty(String name_param, Class<?> type__) throws Exception {}

    @Override
    protected void enlistVerticesProperty(String name_param, Class<?> type__) throws Exception {}

    private Map<V, Integer> generateVertexIdentifiers(Graph<V, E> graph_param) {
        Map<V, Integer> vertexIdentifiers = new HashMap<V, Integer>();
        int count = 1;

        for (V vertex : graph_param.getVertices0()) {
    ...
    @Override
    protected void startGraph(String name_param) throws Exception {
        ...
        printWriter.format("%s %s {%n", graphDeclaration, name_param);
    }
