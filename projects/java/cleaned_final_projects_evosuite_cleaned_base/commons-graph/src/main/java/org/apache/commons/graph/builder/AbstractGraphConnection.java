...
public abstract class AbstractGraphConnection<V, E> implements GraphConnection<V, E> {
    ...
    public final void connect(GraphConnector<V, E> connector_param) {
        connect1(connector_param);
    }

    /** {@inheritDoc} */
    public final void connect1(GraphConnector<V, E> connector_param) {
        checkState(this.connector == null, "Re-entry not allowed!");
        this.connector = connector_param;
