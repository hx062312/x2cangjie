...
final class FibonacciHeapNode<E> {
     ...
     */
    public FibonacciHeapNode(E element_param) {
        degree = 0;
        setParent(null);
        setChild(null);
        setLeft(this);
     ...
     */
    public void setChild(FibonacciHeapNode<E> child_param) {
        this.child = child_param;
    }
     ...
     */
    public void setLeft(FibonacciHeapNode<E> left_param) {
     ...
     */
    public void setMarked(boolean marked_param) {
        this.marked = marked_param;
    }
     ...
     */
    public void setParent(FibonacciHeapNode<E> parent_param) {
        this.parent = parent_param;
    }
     ...
     */
    public void setRight(FibonacciHeapNode<E> right_param) {
