...
final class DefaultKFactorBuilder<P> implements KFactorBuilder<P> {
    ...
    public DefaultKFactorBuilder(
            DirectedGraph<P, GameResult> tournamentGraph_param, PlayersRank<P> playerRanking_param) {
        this.tournamentGraph = tournamentGraph_param;
        this.playerRanking = playerRanking_param;
    }
