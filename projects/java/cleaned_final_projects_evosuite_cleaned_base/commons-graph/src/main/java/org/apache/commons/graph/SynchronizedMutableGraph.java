...
final class SynchronizedMutableGraph<V, E> extends SynchronizedGraph<V, E>
    ...
    private static final long serialVersionUID_field = -5985121601939852063L;
     ...
     */
    public SynchronizedMutableGraph(MutableGraph<V, E> g_param) {
        super(g_param);
        this.mutableGraph = g_param;
    }
