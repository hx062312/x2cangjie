...
public final class DefaultExportSelector<V, E> implements NamedExportSelector<V, E> {
     ...
     */
    public DefaultExportSelector(Graph<V, E> graph_param) {
    ...
    /** {@inheritDoc} */
    public ExportSelector<V, E> withName(String name_param) {
        this.name = checkNotNull(name_param, "Graph name cannot be null.");
        return this;
    }
}
