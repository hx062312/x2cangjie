...
public class EvictionConfig {
    ...
    public EvictionConfig(
            final Duration idleEvictDuration_param,
            final Duration idleSoftEvictDuration_param,
            final int minIdle_param) {
        this.idleEvictDuration =
                PoolImplUtils.isPositive(idleEvictDuration_param) ? idleEvictDuration_param : MAX_DURATION;
        this.idleSoftEvictDuration =
                PoolImplUtils.isPositive(idleSoftEvictDuration_param)
                        ? idleSoftEvictDuration_param
                        : MAX_DURATION;
    ...
    public static EvictionConfig EvictionConfig0(
            final long poolIdleEvictMillis, final long poolIdleSoftEvictMillis, final int minIdle_param) {
