...
class BaseProxyHandler<T> {
     ...
     */
    BaseProxyHandler(final T pooledObject_param, final UsageTracking<T> usageTracking_param) {
        this.pooledObject = pooledObject_param;
        this.usageTracking = usageTracking_param;
    }
