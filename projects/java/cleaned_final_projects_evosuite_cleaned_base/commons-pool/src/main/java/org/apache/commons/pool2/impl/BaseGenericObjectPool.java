...
public abstract class BaseGenericObjectPool<T> extends BaseObject {
    ...
    class BaseGenericObjectPool_EvictionIterator implements Iterator<PooledObject<T>> {

        private final Deque<PooledObject<T>> idleObjects;
        private final Iterator<PooledObject<T>> idleObjectIterator;

        /**
         * Constructs an BaseGenericObjectPool_EvictionIterator for the provided idle instance deque.
         *
         * @param idleObjects underlying deque.
         */
        BaseGenericObjectPool_EvictionIterator(final Deque<PooledObject<T>> idleObjects_param) {
            this.idleObjects = idleObjects_param;

            if (getLifo()) {
                idleObjectIterator = idleObjects_param.descendingIterator();
            } else {
                idleObjectIterator = idleObjects_param.iterator();
            }
        }
     ...
     */
    class BaseGenericObjectPool_Evictor {
         ...
         * shared for all Pools but pools may exist in different class loaders, the BaseGenericObjectPool_Evictor ensures
         ...
         */
        void setScheduledFuture(final ScheduledFuture<?> scheduledFuture_param) {
            this.scheduledFuture = scheduledFuture_param;
        }
    }
     ...
     */
    static class BaseGenericObjectPool_IdentityWrapper<T> {
        /** Wrapped object */
         ...
         */
        public BaseGenericObjectPool_IdentityWrapper(final T instance_param) {
            this.instance = instance_param;
        }

        @Override
        @SuppressWarnings("rawtypes")
        public boolean equals(final Object other) {
            return other instanceof BaseGenericObjectPool_IdentityWrapper
                    && ((BaseGenericObjectPool_IdentityWrapper) other).instance == instance;
        }
        ...
        public String toString() {
            ...
            builder.append("BaseGenericObjectPool_IdentityWrapper [instance=");
     ...
     */
    private class BaseGenericObjectPool_StatsStore {
        ...
        /**
         * Constructs a BaseGenericObjectPool_StatsStore with the given cache size.
         *
         * @param size number of values to maintain in the cache.
         */
        BaseGenericObjectPool_StatsStore(final int size_param) {
            this.size = size_param;
            values = new AtomicLong[size_param];
        ...
        public String toString() {
            final StringBuilder builder = new StringBuilder();
            builder.append("BaseGenericObjectPool_StatsStore [");
    ...
    private BaseGenericObjectPool_Evictor evictor; // @GuardedBy("evictionLock")
    BaseGenericObjectPool_EvictionIterator evictionIterator; // @GuardedBy("evictionLock")
    ...
    private final BaseGenericObjectPool_StatsStore activeTimes = new BaseGenericObjectPool_StatsStore(MEAN_TIMING_STATS_CACHE_SIZE);
    private final BaseGenericObjectPool_StatsStore idleTimes = new BaseGenericObjectPool_StatsStore(MEAN_TIMING_STATS_CACHE_SIZE);
    private final BaseGenericObjectPool_StatsStore waitTimes = new BaseGenericObjectPool_StatsStore(MEAN_TIMING_STATS_CACHE_SIZE);
    ...
    ArrayList<PooledObject<T>> createRemoveList(
            final AbandonedConfig abandonedConfig_param,
            final Map<BaseGenericObjectPool_IdentityWrapper<T>, PooledObject<T>> allObjects) {
        final Instant timeout =
                Instant.now().minus(abandonedConfig_param.getRemoveAbandonedTimeoutDuration());
    ...
    /**
     * Gets the timeout that will be used when waiting for the BaseGenericObjectPool_Evictor to shutdown if this pool is
     * closed and it is the only pool still using the the value for the BaseGenericObjectPool_Evictor.
     *
     * @return The timeout that will be used while waiting for the BaseGenericObjectPool_Evictor to shut down.
     * @since 2.10.0
     ...
     * closed and it is the only pool still using the the value for the BaseGenericObjectPool_Evictor.
     *
     * @return The timeout in milliseconds that will be used while waiting for the BaseGenericObjectPool_Evictor to shut
     *     down.
     * @deprecated Use {@link #getEvictorShutdownTimeoutDuration()}.
     */
    @Deprecated
     ...
     * @since 2.11.0
     */
    public void setAbandonedConfig(final AbandonedConfig abandonedConfig_param) {
        this.abandonedConfig = AbandonedConfig.copy(abandonedConfig_param);
    }
     ...
     */
    public final void setBlockWhenExhausted(final boolean blockWhenExhausted_param) {
        this.blockWhenExhausted = blockWhenExhausted_param;
    }
     ...
     * @since 2.6.0
     */
    public void setEvictionPolicy0(final EvictionPolicy<T> evictionPolicy_param) {
        this.evictionPolicy = evictionPolicy_param;
    }
    ...
    /**
     * Sets the timeout that will be used when waiting for the BaseGenericObjectPool_Evictor to shutdown if this pool is
     * closed and it is the only pool still using the the value for the BaseGenericObjectPool_Evictor.
     *
     * @param evictorShutdownTimeout the timeout in milliseconds that will be used while waiting for
     *     the BaseGenericObjectPool_Evictor to shut down.
     * @since 2.10.0
     */
     ...
     *     waiting for the BaseGenericObjectPool_Evictor to shut down.
     ...
     * @see #getLifo()
     */
    public final void setLifo(final boolean lifo_param) {
        this.lifo = lifo_param;
    }
     ...
     * @see #getMaxTotal
     */
    public final void setMaxTotal(final int maxTotal_param) {
        this.maxTotal = maxTotal_param;
    }
     ...
     * @since 2.11.0
     */
    public final void setMaxWait(final Duration maxWaitDuration_param) {
        this.maxWaitDuration =
                PoolImplUtils.nonNull(maxWaitDuration_param, BaseObjectPoolConfig.DEFAULT_MAX_WAIT);
    }
     ...
     * @see #setTimeBetweenEvictionRunsMillis
     */
    public final void setNumTestsPerEvictionRun(final int numTestsPerEvictionRun_param) {
        this.numTestsPerEvictionRun = numTestsPerEvictionRun_param;
    }
    ...
    public final void setSwallowedExceptionListener(
            final SwallowedExceptionListener swallowedExceptionListener_param) {
        this.swallowedExceptionListener = swallowedExceptionListener_param;
    }
     ...
     * @see #getTestOnBorrow
     */
    public final void setTestOnBorrow(final boolean testOnBorrow_param) {
        this.testOnBorrow = testOnBorrow_param;
    }
     ...
     * @since 2.2
     */
    public final void setTestOnCreate(final boolean testOnCreate_param) {
        this.testOnCreate = testOnCreate_param;
    }
     ...
     * @see #getTestOnReturn
     */
    public final void setTestOnReturn(final boolean testOnReturn_param) {
        this.testOnReturn = testOnReturn_param;
    }
     ...
     * @see #setTimeBetweenEvictionRuns
     */
    public final void setTestWhileIdle(final boolean testWhileIdle_param) {
        this.testWhileIdle = testWhileIdle_param;
    }
