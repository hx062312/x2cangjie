...
public class GenericKeyedObjectPoolConfig<T> extends BaseObjectPoolConfig<T> {
     ...
     */
    public void setMaxIdlePerKey(final int maxIdlePerKey_param) {
        this.maxIdlePerKey = maxIdlePerKey_param;
    }
     ...
     */
    public void setMaxTotal(final int maxTotal_param) {
     ...
     */
    public void setMaxTotalPerKey(final int maxTotalPerKey_param) {
        this.maxTotalPerKey = maxTotalPerKey_param;
    }
     ...
     */
    public void setMinIdlePerKey(final int minIdlePerKey_param) {
        this.minIdlePerKey = minIdlePerKey_param;
    }
