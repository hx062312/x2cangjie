...
public class JdkProxySource<T> implements ProxySource<T> {
     ...
     */
    public JdkProxySource(final ClassLoader classLoader_param, final Class<?>[] interfaces_param) {
        this.classLoader = classLoader_param;
        this.interfaces = new Class<?>[interfaces_param.length];
        System.arraycopy(interfaces_param, 0, this.interfaces, 0, interfaces_param.length);
    }
