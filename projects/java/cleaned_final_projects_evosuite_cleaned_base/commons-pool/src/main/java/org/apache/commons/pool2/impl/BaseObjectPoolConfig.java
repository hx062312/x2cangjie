...
public abstract class BaseObjectPoolConfig<T> extends BaseObject implements Cloneable {
     ...
     * @see GenericKeyedObjectPool#getBlockWhenExhausted()
     */
    public void setBlockWhenExhausted(final boolean blockWhenExhausted_param) {
     ...
     * @since 2.6.0
     */
    public void setEvictionPolicy(final EvictionPolicy<T> evictionPolicy_param) {
     ...
     * @see GenericKeyedObjectPool#getEvictionPolicyClassName()
     */
    public void setEvictionPolicyClassName(final String evictionPolicyClassName_param) {
        this.evictionPolicyClassName = evictionPolicyClassName_param;
    }
     ...
     * @since 2.11.0
     */
    public void setEvictorShutdownTimeout(final Duration evictorShutdownTimeoutDuration_param) {
        this.evictorShutdownTimeoutDuration =
                PoolImplUtils.nonNull(
                        evictorShutdownTimeoutDuration_param, DEFAULT_EVICTOR_SHUTDOWN_TIMEOUT);
    }
     ...
     * @see GenericKeyedObjectPool#getFairness()
     */
    public void setFairness(final boolean fairness_param) {
        this.fairness = fairness_param;
    }
     ...
     */
    public void setJmxEnabled(final boolean jmxEnabled_param) {
        this.jmxEnabled = jmxEnabled_param;
    }
     ...
     */
    public void setJmxNameBase(final String jmxNameBase_param) {
        this.jmxNameBase = jmxNameBase_param;
    }
     ...
     */
    public void setJmxNamePrefix(final String jmxNamePrefix_param) {
        this.jmxNamePrefix = jmxNamePrefix_param;
    }
     ...
     * @see GenericKeyedObjectPool#getLifo()
     */
    public void setLifo(final boolean lifo_param) {
     ...
     * @since 2.11.0
     */
    public void setMaxWait(final Duration maxWaitDuration_param) {
        this.maxWaitDuration = PoolImplUtils.nonNull(maxWaitDuration_param, DEFAULT_MAX_WAIT);
    }
     ...
     * @see GenericKeyedObjectPool#getNumTestsPerEvictionRun()
     */
    public void setNumTestsPerEvictionRun(final int numTestsPerEvictionRun_param) {
     ...
     * @see GenericKeyedObjectPool#getTestOnBorrow()
     */
    public void setTestOnBorrow(final boolean testOnBorrow_param) {
     ...
     * @since 2.2
     */
    public void setTestOnCreate(final boolean testOnCreate_param) {
     ...
     * @see GenericKeyedObjectPool#getTestOnReturn()
     */
    public void setTestOnReturn(final boolean testOnReturn_param) {
     ...
     * @see GenericKeyedObjectPool#getTestWhileIdle()
     */
    public void setTestWhileIdle(final boolean testWhileIdle_param) {
