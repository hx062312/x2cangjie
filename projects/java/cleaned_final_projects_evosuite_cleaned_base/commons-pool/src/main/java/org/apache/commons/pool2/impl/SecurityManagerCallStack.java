...
public class SecurityManagerCallStack {
    ...
    private static class SecurityManagerCallStack_PrivateSecurityManager extends SecurityManager {
    ...
    private static class SecurityManagerCallStack_Snapshot {
         ...
         */
        private SecurityManagerCallStack_Snapshot(final List<WeakReference<Class<?>>> stack_param) {
            this.stack = stack_param;
        }
    }

    private volatile SecurityManagerCallStack_Snapshot snapshot;
