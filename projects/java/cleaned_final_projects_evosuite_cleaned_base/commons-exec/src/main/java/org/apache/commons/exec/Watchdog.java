...
public class Watchdog implements Runnable {
     ...
     * @since 1.4.0
     */
    public static final class Watchdog_Builder implements Supplier<Watchdog> {
         ...
         * @return this.
         */
        public Watchdog_Builder setThreadFactory(final ThreadFactory threadFactory_param) {
         ...
         * @return this.
         */
        public Watchdog_Builder setTimeout(final Duration timeout_param) {
     ...
     * @since 1.4.0
     */
    public static Watchdog_Builder builder() {
        return new Watchdog_Builder();
    }
     ...
     * @deprecated Use {@link Watchdog_Builder#get()}.
     */
    @Deprecated
    public static Watchdog Watchdog0(final long timeoutMillis_param) {
        return new Watchdog(null, Duration.ofMillis(timeoutMillis_param));
    }
     ...
     * @param timeout       the timeout duration.
     */
    private Watchdog(final ThreadFactory threadFactory_param, final Duration timeout) {
