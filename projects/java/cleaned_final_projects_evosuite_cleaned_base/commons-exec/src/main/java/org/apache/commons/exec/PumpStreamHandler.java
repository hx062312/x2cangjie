...
public class PumpStreamHandler implements ExecuteStreamHandler {
     ...
     */
    public static PumpStreamHandler PumpStreamHandler2(final OutputStream outputStream_param, final OutputStream errorOutputStream_param) {
        return PumpStreamHandler3(outputStream_param, errorOutputStream_param, null);
    }
     ...
     */
    public static PumpStreamHandler PumpStreamHandler3(final OutputStream outputStream_param, final OutputStream errorOutputStream_param, final InputStream inputStream_param) {
        return new PumpStreamHandler(Executors.defaultThreadFactory(), outputStream_param, errorOutputStream_param, inputStream_param);
    }
     ...
     * @param inputStream       the input {@link InputStream}.
     */
    private PumpStreamHandler(final ThreadFactory threadFactory_param, final OutputStream outputStream_param, final OutputStream errorOutputStream_param,
            final InputStream inputStream_param) {
        this.threadFactory = threadFactory_param;
        this.outputStream = outputStream_param;
        this.errorOutputStream = errorOutputStream_param;
        this.inputStream = inputStream_param;
    }
     ...
     */
    protected void createProcessErrorPump(final InputStream is__, final OutputStream os) {
        errorThread = createPump0(is__, os);
    }
     ...
     * @param os the {@link OutputStream}.
     */
    protected void createProcessOutputPump(final InputStream is__, final OutputStream os) {
        outputThread = createPump0(is__, os);
    }
     ...
     */
    protected Thread createPump0(final InputStream is__, final OutputStream os) {
        return createPump1(is__, os, os instanceof PipedOutputStream);
    }
     ...
     * @return the stream pumper thread.
     */
    protected Thread createPump1(final InputStream is__, final OutputStream os, final boolean closeWhenExhausted) {
        return ThreadUtil.newThread(threadFactory, new StreamPumper(is__, os, closeWhenExhausted, -1), "CommonsExecStreamPumper-", true);
    }
     ...
     * @return the stream pumper thread.
     */
    private Thread createSystemInPump(final InputStream is__, final OutputStream os) {
        inputStreamPumper = new InputStreamPumper(is__, os);
     ...
     */
    @Override
    public void setProcessErrorStream(final InputStream is__) {
        if (errorOutputStream != null) {
            createProcessErrorPump(is__, errorOutputStream);
        }
    }
     ...
     */
    @Override
    public void setProcessOutputStream(final InputStream is__) {
        if (outputStream != null) {
            createProcessOutputPump(is__, outputStream);
        }
    }
