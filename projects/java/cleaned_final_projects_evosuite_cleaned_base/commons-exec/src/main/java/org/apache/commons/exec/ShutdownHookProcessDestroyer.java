...
public class ShutdownHookProcessDestroyer implements ProcessDestroyer, Runnable {
    ...
    private final class ShutdownHookProcessDestroyer_ProcessDestroyerThread extends Thread {

        private boolean shouldDestroy = true;

        public ShutdownHookProcessDestroyer_ProcessDestroyerThread() {
        ...
        public void setShouldDestroy(final boolean shouldDestroy_param) {
            this.shouldDestroy = shouldDestroy_param;
        }
    }
    ...
    private ShutdownHookProcessDestroyer_ProcessDestroyerThread destroyProcessThread;
    ...
    private void addShutdownHook() {
        if (!running) {
            destroyProcessThread = new ShutdownHookProcessDestroyer_ProcessDestroyerThread();
