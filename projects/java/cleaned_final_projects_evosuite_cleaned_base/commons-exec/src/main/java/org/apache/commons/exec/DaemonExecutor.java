...
public class DaemonExecutor extends DefaultExecutor {
     ...
     * @since 1.4.0
     */
    public static class DaemonExecutor_Builder extends DefaultExecutor.DefaultExecutor_Builder<DaemonExecutor_Builder> {
     ...
     * @since 1.4.0
     */
    public static DaemonExecutor_Builder builder() {
        return new DaemonExecutor_Builder();
    }

    /**
     * Constructs a new instance.
     *
     * @deprecated Use {@link DaemonExecutor_Builder#get()}.
     */

    private DaemonExecutor(final ThreadFactory threadFactory_param, final ExecuteStreamHandler executeStreamHandler_param, final File workingDirectory_param) {
        super(threadFactory_param, executeStreamHandler_param, workingDirectory_param);
    }
