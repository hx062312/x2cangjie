...
public class DefaultExecutor implements Executor {
     ...
     * @since 1.4.0
     */
    public static class DefaultExecutor_Builder<T extends DefaultExecutor_Builder<T>> implements Supplier<DefaultExecutor> {
         ...
         * @return this.
         */
        public T setExecuteStreamHandler(final ExecuteStreamHandler executeStreamHandler_param) {
            this.executeStreamHandler = executeStreamHandler_param;
            return asThis();
        }
         ...
         * @return this.
         */
        public T setThreadFactory(final ThreadFactory threadFactory_param) {
            this.threadFactory = threadFactory_param;
            return asThis();
        }
         ...
         * @return this.
         */
        public T setWorkingDirectory(final File workingDirectory_param) {
            this.workingDirectory = workingDirectory_param;
            return asThis();
        }
     ...
     * @since 1.4.0
     */
    public static DefaultExecutor_Builder<?> builder() {
        return new DefaultExecutor_Builder<>();
    }
     ...
     *
     * @deprecated Use {@link DefaultExecutor_Builder#get()}.
     */
    @Deprecated
    ...
    DefaultExecutor(final ThreadFactory threadFactory_param, final ExecuteStreamHandler executeStreamHandler_param, final File workingDirectory_param) {
        this.threadFactory = threadFactory_param != null ? threadFactory_param : Executors.defaultThreadFactory();
        this.executeStreamHandler = executeStreamHandler_param != null ? executeStreamHandler_param : PumpStreamHandler.PumpStreamHandler0();
        this.workingDirectory = workingDirectory_param != null ? workingDirectory_param : new File(".");
     ...
     */
    private int executeInternal(final CommandLine command, final Map<String, String> environment, final File workingDirectory_param,
            final ExecuteStreamHandler streams) throws IOException {
        final Process process;
        exceptionCaught = null;
        try {
            process = launch(command, environment, workingDirectory_param);
        } catch (final IOException e) {
            if (watchdog != null) {
     ...
     */
    protected Process launch(final CommandLine command, final Map<String, String> env, final File workingDirectory_param) throws IOException {
        if (launcher == null) {
            throw new IllegalStateException("CommandLauncher can not be null");
        }
        checkWorkingDirectory1(workingDirectory_param);
        return launcher.exec1(command, env, workingDirectory_param);
    }
     ...
     */
    @Override
    public void setProcessDestroyer(final ProcessDestroyer processDestroyer_param) {
        this.processDestroyer = processDestroyer_param;
    }
     ...
     */
    @Override
    public void setWatchdog(final ExecuteWatchdog watchdog_param) {
        this.watchdog = watchdog_param;
    }
     ...
     * @deprecated Use {@link DefaultExecutor_Builder#setWorkingDirectory(File)}.
     */
    @Deprecated
    @Override
    public void setWorkingDirectory(final File workingDirectory_param) {
        this.workingDirectory = workingDirectory_param;
    }
