...
public abstract class LogOutputStream extends OutputStream {
    ...
    private static final class LogOutputStream_ByteArrayOutputStreamX extends ByteArrayOutputStream {
        private LogOutputStream_ByteArrayOutputStreamX(final int size) {
            super(size);
        }
    ...
    /** The internal buffer. */
    private final LogOutputStream_ByteArrayOutputStreamX buffer = new LogOutputStream_ByteArrayOutputStreamX(INTIAL_SIZE);
     ...
     */
    public LogOutputStream(int constructorId, final int level_param, final Charset charset_param) {
        if (constructorId == 0) {
            this.level = 999;
            this.charset = null;
        } else if (constructorId == 1) {
            this.level = level_param;
            this.charset = null;
        } else {
            this.level = level_param;
            this.charset = charset_param == null ? Charset.defaultCharset() : charset_param;    
        }
    }
