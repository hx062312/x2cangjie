...
public class ExecuteException extends IOException {
     ...
     */
    public ExecuteException(final String message, final int exitValue_param, final Throwable cause) {
        super(message + " (Exit value: " + exitValue_param + ")", cause);
        this.exitValue = exitValue_param;
    }
