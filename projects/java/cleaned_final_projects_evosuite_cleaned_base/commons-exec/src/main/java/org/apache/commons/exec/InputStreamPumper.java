...
public class InputStreamPumper implements Runnable {
    ...
    private final InputStream is__;
     ...
     */
    public InputStreamPumper(final InputStream is___param, final OutputStream os_param) {
        this.is__ = is___param;
        this.os = os_param;
        this.stop = false;
    }
