...
public final class S9 {
	 ...
	 */
	public static int estimatecompress(int[] in__, int currentPos, int inlength) {
		int tmpoutpos = 0;
	 ...
	 */
	public static int compress(int[] in__, int currentPos, int inlength, int out[], int tmpoutpos) {
