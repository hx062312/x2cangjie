...
SkippableIntegratedIntegerCODEC  {
    ...
    public void compress0(int[] in__, IntWrapper inpos, int inlength,
        ...
        for (int k = inpos.get(); k < inpos.get() + inlength; ++k) {
            final long val = (in__[k] - initoffset) & 0xFFFFFFFFL; // To be consistent with unsigned integers in C/C++
            initoffset = in__[k];
            if (val < (1 << 7)) {
    ...
    @Override
    public void compress1(int[] in__, IntWrapper inpos, int inlength,
