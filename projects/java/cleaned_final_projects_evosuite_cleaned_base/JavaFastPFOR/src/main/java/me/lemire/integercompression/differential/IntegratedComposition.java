...
public class IntegratedComposition implements IntegratedIntegerCODEC {
        ...
        public void compress0(int[] in__, IntWrapper inpos, int inlength,
            ...
            F1.compress0(in__, inpos, inlength, out, outpos);
            if (outpos.get() == outposInit) {
                out[outposInit] = 0;
                outpos.increment();
            }
            inlength -= inpos.get() - inposInit;
            F2.compress0(in__, inpos, inlength, out, outpos);
        }
        ...
        public void uncompress0(int[] in__, IntWrapper inpos, int inlength,
                ...
                F1.uncompress0(in__, inpos, inlength, out, outpos);
                inlength -= inpos.get() - init__;
                F2.uncompress0(in__, inpos, inlength, out, outpos);
        }
