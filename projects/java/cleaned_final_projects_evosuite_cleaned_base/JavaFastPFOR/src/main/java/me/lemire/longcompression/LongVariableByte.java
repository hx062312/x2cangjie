...
public class LongVariableByte implements LongCODEC, ByteLongCODEC, SkippableLongCODEC {
    ...
    @Override
    public void compress0(long[] in__, IntWrapper inpos, int inlength, long[] out,
                          IntWrapper outpos) {
        headlessCompress(in__, inpos, inlength, out, outpos);
    }

    @Override
    public void headlessCompress(long[] in__, IntWrapper inpos, int inlength, long[] out,
            IntWrapper outpos) {
        if (inlength == 0)
            return;
    ...
    @Override
    public void compress1(long[] in__, IntWrapper inpos, int inlength, byte[] out,
                          IntWrapper outpos) {
        if (inlength == 0)
            return;
    ...
    @Override
    public void uncompress1(long[] in__, IntWrapper inpos, int inlength, long[] out,
                            IntWrapper outpos) {
        int s = 0;
        long val = 0;
        int p = inpos.get();
    ...
    @Override
    public void uncompress1(byte[] in__, IntWrapper inpos, int inlength,
        ...
        for (long v = 0; p < finalp; out[tmpoutpos++] = v) {
            ...
            v = ((in__[p + 2] & 0x7F) << 14) | v;
            if (in__[p + 2] < 0 ) {
                p += 3;
                continue;
            }
            v = ((in__[p + 3] & 0x7F) << 21) | v;
            if (in__[p + 3] < 0) {
                p += 4;
                continue;
            }
            v = (((long) in__[p + 4] & 0x7F) << 28) | v;
            if (in__[p + 4] < 0) {
                p += 5;
                continue;
            }
            v = (((long) in__[p + 5] & 0x7F) << 35) | v;
            if (in__[p + 5] < 0) {
                p += 6;
                continue;
            }
            v = (((long) in__[p + 6] & 0x7F) << 42) | v;
            if (in__[p + 6] < 0) {
                p += 7;
                continue;
            }
            v = (((long) in__[p + 7] & 0x7F) << 49) | v;
            if (in__[p + 7] < 0) {
                p += 8;
                continue;
            }
            v = (((long) in__[p + 8] & 0x7F) << 56) | v;
            if (in__[p + 8] < 0) {
                p += 9;
                continue;
            }
            v = (((long) in__[p + 9] & 0x7F) << 63) | v;
            p += 10;
        }
        outpos.set(tmpoutpos);
        inpos.add(p);
    ...
    @Override
    public void headlessUncompress(long[] in__, IntWrapper inpos, int inlength, long[] out,
