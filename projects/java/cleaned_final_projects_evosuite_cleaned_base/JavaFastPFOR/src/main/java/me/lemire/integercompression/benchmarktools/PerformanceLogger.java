...
public final class PerformanceLogger {
        static class PerformanceLogger_Timer {
                private long startNano;
                private long duration = 0;

                public PerformanceLogger_Timer() {
                }
        ...
        final PerformanceLogger_Timer compressionTimer = new PerformanceLogger_Timer();

        final PerformanceLogger_Timer decompressionTimer = new PerformanceLogger_Timer();
