...
public final class Simple9 implements IntegerCODEC, SkippableIntegerCODEC {
	...
	public void headlessCompress(int[] in__, IntWrapper inpos, int inlength, int out[], IntWrapper outpos) {
		...
		outer: while (currentPos < finalin - 28) {
			...
			if (in__[currentPos] >= 1 << bitLength[selector])
	...
	@Override
	public void headlessUncompress(int[] in__, IntWrapper inpos, int inlength, int[] out, IntWrapper outpos,
			int outlength) {
