...
public final class DeltaZigzagEncoding {
        ...
        static class DeltaZigzagEncoding_Context {
                int contextValue;

                DeltaZigzagEncoding_Context(int contextValue_param) {
                        this.contextValue = contextValue_param;
                }

                void setContextValue(int contextValue_param) {
                        this.contextValue = contextValue_param;
                }
        ...
        static class DeltaZigzagEncoding_Encoder extends DeltaZigzagEncoding_Context {
                DeltaZigzagEncoding_Encoder(int contextValue_param) {
                        super(contextValue_param);
                }
        ...
        static class DeltaZigzagEncoding_Decoder extends DeltaZigzagEncoding_Context {
                DeltaZigzagEncoding_Decoder(int contextValue_param) {
                        super(contextValue_param);
                }
