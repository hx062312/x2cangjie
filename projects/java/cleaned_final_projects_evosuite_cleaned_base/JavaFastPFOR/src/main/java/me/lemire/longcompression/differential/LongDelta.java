...
public final class LongDelta {
         ...
         */
        public static long delta1(long[] data, int start, int length, int init__) {
         ...
         * @return next initial vale
         */
        public static long delta2(long[] data, int start, int length, int init__,
                                  long[] out) {
                for (int i = length - 1; i > 0; --i) {
                        out[i] = data[start + i] - data[start + i - 1];
                }
                out[0] = data[start] - init__;
