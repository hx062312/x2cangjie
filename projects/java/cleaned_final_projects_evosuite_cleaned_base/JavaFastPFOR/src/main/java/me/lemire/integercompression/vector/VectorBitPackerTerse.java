...
public class VectorBitPackerTerse {
  ...
  private static void fastpackOddBit(final int[] in__, int inpos, final int[] out,
    ...
    int n = 1;
    for (; n <= N; n++) {
      iV = IntVector.fromArray(SPECIES_256, in__, inpos + n * VLEN_256);
  ...
  private static void fastpackOddBitNoMask(final int[] in__, int inpos,
  ...
  private static void fastUnpackOddBit(final int[] in__, int inpos,
                                       final int[] out, int outpos, int b,
    ...
    final int L = b - 1;
    for (int i = 0; i < L; i++) {
      iV = IntVector.fromArray(SPECIES_256, in__, inpos + (i + 1) * VLEN_256);
  ...
  private static void fastpackEvenBit(final int[] in__, int inpos,
                                      final int[] out, int outpos, int b,
                                      final int[] ho, final int[] lc) {
    final int mask = (1 << b) - 1;
    ...
    int n = 1;
    for (; n <= N; n++) {
      iV = IntVector.fromArray(SPECIES_512, in__, inpos + n * VLEN_512);
      oV = iV.and(mask).lanewise(VectorOperators.LSHL, b * n).or(oV);
    }
    oV.intoArray(out, outpos);
    outpos += VLEN_512;
  ...
  private static void fastpackEvenBitNoMask(final int[] in__, int inpos,
                                            final int[] out, int outpos, int b,
                                            final int[] ho, final int[] lc) {
    final int N = 32 % b == 0 ? (32 / b) - 1 : 32 / b;
    var iV = IntVector.fromArray(SPECIES_512, in__, inpos);
  ...
  private static void fastUnpackEventBit(final int[] in__, int inpos,
                                         final int[] out, int outpos, int b,
    ...
    final int L = (b >>> 1) - 1;
    for (int i = 0; i < L; i++) {
      iV = IntVector.fromArray(SPECIES_512, in__, inpos + (i + 1) * VLEN_512);
      oV = iV.and(masks[i]).lanewise(VectorOperators.LSHL, b - lo[i]).or(oV);
      oV.intoArray(out, outpos);
      outpos += VLEN_512;
      int j = 0;
  ...
  public static void fastpack(final int[] in__, int inpos, final int[] out,
    ...
    case 0:
      break;
    case 1:
      fastpackOddBit(in__, inpos, out, outpos, 1, new int[] {}, new int[] {});
      break;
    case 2:
      fastpackEvenBit(in__, inpos, out, outpos, 2, new int[] {}, new int[] {});
      break;
    case 3:
      fastpackOddBit(in__, inpos, out, outpos, 3, new int[] {0x2, 0x1},
                     new int[] {0xb, 0xa});
      break;
    case 4:
      fastpackEvenBit(in__, inpos, out, outpos, 4, new int[] {0x4},
                      new int[] {0x8});
      break;
    case 5:
      fastpackOddBit(in__, inpos, out, outpos, 5, new int[] {0x2, 0x4, 0x1, 0x3},
                     new int[] {0x6, 0x7, 0x6, 0x6});
      break;
    case 6:
      fastpackEvenBit(in__, inpos, out, outpos, 6, new int[] {0x2, 0x4},
                      new int[] {0x5, 0x5});
      break;
    case 7:
      fastpackOddBit(in__, inpos, out, outpos, 7,
                     new int[] {0x4, 0x1, 0x5, 0x2, 0x6, 0x3},
                     new int[] {0x5, 0x4, 0x5, 0x4, 0x5, 0x4});
      break;
    case 8:
      fastpackEvenBit(in__, inpos, out, outpos, 8, new int[] {0x8, 0x8, 0x8},
                      new int[] {0x4, 0x4, 0x4});
      break;
    case 9:
      fastpackOddBit(in__, inpos, out, outpos, 9,
                     new int[] {0x5, 0x1, 0x6, 0x2, 0x7, 0x3, 0x8, 0x4},
                     new int[] {0x4, 0x3, 0x4, 0x3, 0x4, 0x3, 0x4, 0x3});
      break;
    case 10:
      fastpackEvenBit(in__, inpos, out, outpos, 10,
                      new int[] {0x2, 0x4, 0x6, 0x8},
                      new int[] {0x3, 0x3, 0x3, 0x3});
      break;
    case 11:
      fastpackOddBit(
          in__, inpos, out, outpos, 11,
          new int[] {0xa, 0x9, 0x8, 0x7, 0x6, 0x5, 0x4, 0x3, 0x2, 0x1},
          new int[] {0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x2});
      break;
    case 12:
      fastpackEvenBit(in__, inpos, out, outpos, 12,
                      new int[] {0x8, 0x4, 0xc, 0x8, 0x4},
                      new int[] {0x3, 0x2, 0x3, 0x3, 0x2});
      break;
    case 13:
      fastpackOddBit(in__, inpos, out, outpos, 13,
      ...
      break;
    case 14:
      fastpackEvenBit(in__, inpos, out, outpos, 14,
                      new int[] {0x4, 0x8, 0xc, 0x2, 0x6, 0xa},
                      new int[] {0x2, 0x2, 0x3, 0x2, 0x2, 0x2});
      break;
    case 15:
      fastpackOddBit(in__, inpos, out, outpos, 15,
      ...
      break;
    case 16:
      fastpackEvenBit(in__, inpos, out, outpos, 16,
                      new int[] {0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10},
                      new int[] {0x2, 0x2, 0x2, 0x2, 0x2, 0x2, 0x2});
      break;
    case 17:
      fastpackOddBit(in__, inpos, out, outpos, 17,
      ...
      break;
    case 18:
      fastpackEvenBit(in__, inpos, out, outpos, 18,
                      new int[] {0xe, 0xa, 0x6, 0x2, 0x10, 0xc, 0x8, 0x4},
                      new int[] {0x2, 0x2, 0x2, 0x1, 0x2, 0x2, 0x2, 0x1});
      break;
    case 19:
      fastpackOddBit(in__, inpos, out, outpos, 19,
    ...
    case 25:
      ...
      break;
    case 26:
      fastpackEvenBit(in__, inpos, out, outpos, 26,
      ...
      break;
    case 27:
      fastpackOddBit(in__, inpos, out, outpos, 27,
      ...
      break;
    case 28:
      fastpackEvenBit(in__, inpos, out, outpos, 28,
    ...
    case 29:
      ...
      break;
    case 30:
      fastpackEvenBit(in__, inpos, out, outpos, 30,
      ...
      break;
    case 31:
      fastpackOddBit(in__, inpos, out, outpos, 31,
      ...
      break;
    case 32:
      System.arraycopy(in__, inpos, out, outpos, 256);
      break;
    }
  }

  public static void fastpackNoMask(final int[] in__, int inpos, final int[] out,
                                    int outpos, int b) {
    switch (b) {
    case 0:
      break;
    case 1:
      fastpackOddBitNoMask(in__, inpos, out, outpos, 1, new int[] {},
                           new int[] {});
      break;
    case 2:
      fastpackEvenBitNoMask(in__, inpos, out, outpos, 2, new int[] {},
                            new int[] {});
      break;
    case 3:
      fastpackOddBitNoMask(in__, inpos, out, outpos, 3, new int[] {0x2, 0x1},
                           new int[] {0xb, 0xa});
      break;
    case 4:
      fastpackEvenBitNoMask(in__, inpos, out, outpos, 4, new int[] {0x4},
                            new int[] {0x8});
      break;
    case 5:
      fastpackOddBitNoMask(in__, inpos, out, outpos, 5,
                           new int[] {0x2, 0x4, 0x1, 0x3},
                           new int[] {0x6, 0x7, 0x6, 0x6});
      break;
    case 6:
      fastpackEvenBitNoMask(in__, inpos, out, outpos, 6, new int[] {0x2, 0x4},
                            new int[] {0x5, 0x5});
      break;
    case 7:
      fastpackOddBitNoMask(in__, inpos, out, outpos, 7,
                           new int[] {0x4, 0x1, 0x5, 0x2, 0x6, 0x3},
                           new int[] {0x5, 0x4, 0x5, 0x4, 0x5, 0x4});
      break;
    case 8:
      fastpackEvenBitNoMask(in__, inpos, out, outpos, 8,
                            new int[] {0x8, 0x8, 0x8},
                            new int[] {0x4, 0x4, 0x4});
      break;
    case 9:
      fastpackOddBitNoMask(in__, inpos, out, outpos, 9,
                           new int[] {0x5, 0x1, 0x6, 0x2, 0x7, 0x3, 0x8, 0x4},
                           new int[] {0x4, 0x3, 0x4, 0x3, 0x4, 0x3, 0x4, 0x3});
      break;
    case 10:
      fastpackEvenBitNoMask(in__, inpos, out, outpos, 10,
                            new int[] {0x2, 0x4, 0x6, 0x8},
                            new int[] {0x3, 0x3, 0x3, 0x3});
      break;
    case 11:
      ...
      break;
    case 12:
      fastpackEvenBitNoMask(in__, inpos, out, outpos, 12,
                            new int[] {0x8, 0x4, 0xc, 0x8, 0x4},
                            new int[] {0x3, 0x2, 0x3, 0x3, 0x2});
      break;
    case 13:
      fastpackOddBitNoMask(in__, inpos, out, outpos, 13,
      ...
      break;
    case 14:
      fastpackEvenBitNoMask(in__, inpos, out, outpos, 14,
                            new int[] {0x4, 0x8, 0xc, 0x2, 0x6, 0xa},
                            new int[] {0x2, 0x2, 0x3, 0x2, 0x2, 0x2});
      break;
    case 15:
      fastpackOddBitNoMask(in__, inpos, out, outpos, 15,
    ...
    case 16:
      fastpackEvenBitNoMask(
          in__, inpos, out, outpos, 16,
          new int[] {0x10, 0x10, 0x10, 0x10, 0x10, 0x10, 0x10},
          new int[] {0x2, 0x2, 0x2, 0x2, 0x2, 0x2, 0x2});
      break;
    case 17:
      fastpackOddBitNoMask(in__, inpos, out, outpos, 17,
      ...
      break;
    case 18:
      fastpackEvenBitNoMask(in__, inpos, out, outpos, 18,
                            new int[] {0xe, 0xa, 0x6, 0x2, 0x10, 0xc, 0x8, 0x4},
                            new int[] {0x2, 0x2, 0x2, 0x1, 0x2, 0x2, 0x2, 0x1});
      break;
    case 19:
      fastpackOddBitNoMask(
          in__, inpos, out, outpos, 19,
    ...
    case 24:
      ...
      break;
    case 25:
      fastpackOddBitNoMask(in__, inpos, out, outpos, 25,
      ...
      break;
    case 26:
      fastpackEvenBitNoMask(in__, inpos, out, outpos, 26,
    ...
    case 27:
      ...
      break;
    case 28:
      fastpackEvenBitNoMask(in__, inpos, out, outpos, 28,
    ...
    case 29:
      ...
      break;
    case 30:
      fastpackEvenBitNoMask(in__, inpos, out, outpos, 30,
  ...
  public static void fastunpack(final int[] in__, int inpos, final int[] out,
    ...
    case 0:
      ...
      break;
    case 1:
      fastUnpackOddBit(in__, inpos, out, outpos, 1, new int[] {}, new int[] {},
                       new int[] {});
      break;
    case 2:
      fastUnpackEventBit(in__, inpos, out, outpos, 2, new int[] {}, new int[] {},
                         new int[] {});
      break;
    case 3:
      fastUnpackOddBit(in__, inpos, out, outpos, 3, new int[] {0x1, 0x2},
                       new int[] {0x1, 0x3}, new int[] {0xa, 0xa});
      break;
    case 4:
      fastUnpackEventBit(in__, inpos, out, outpos, 4, new int[] {0x4},
                         new int[] {0xf}, new int[] {0x7});
      break;
    case 5:
      fastUnpackOddBit(
          in__, inpos, out, outpos, 5, new int[] {0x3, 0x1, 0x4, 0x2},
          new int[] {0x7, 0x1, 0xf, 0x3}, new int[] {0x5, 0x6, 0x5, 0x6});
      break;
    case 6:
      fastUnpackEventBit(in__, inpos, out, outpos, 6, new int[] {0x4, 0x2},
                         new int[] {0xf, 0x3}, new int[] {0x4, 0x5});
      break;
    case 7:
      fastUnpackOddBit(in__, inpos, out, outpos, 7,
                       new int[] {0x3, 0x6, 0x2, 0x5, 0x1, 0x4},
                       new int[] {0x7, 0x3f, 0x3, 0x1f, 0x1, 0xf},
                       new int[] {0x4, 0x3, 0x4, 0x3, 0x4, 0x4});
      break;
    case 8:
      fastUnpackEventBit(in__, inpos, out, outpos, 8, new int[] {0x8, 0x8, 0x8},
                         new int[] {0xff, 0xff, 0xff},
                         new int[] {0x3, 0x3, 0x3});
      break;
    case 9:
      fastUnpackOddBit(in__, inpos, out, outpos, 9,
    ...
    case 10:
      fastUnpackEventBit(
          in__, inpos, out, outpos, 10, new int[] {0x8, 0x6, 0x4, 0x2},
    ...
    case 16:
      ...
      break;
    case 17:
      fastUnpackOddBit(in__, inpos, out, outpos, 17,
    ...
    case 18:
      ...
      break;
    case 19:
      fastUnpackOddBit(in__, inpos, out, outpos, 19,
    ...
    case 25:
      ...
      break;
    case 26:
      fastUnpackEventBit(in__, inpos, out, outpos, 26,
    ...
    case 27:
      ...
      break;
    case 28:
      fastUnpackEventBit(in__, inpos, out, outpos, 28,
    ...
    case 29:
      ...
      break;
    case 30:
      fastUnpackEventBit(in__, inpos, out, outpos, 30,
