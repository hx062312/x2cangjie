...
public class PForDeltaUnpack128 {
        ...
        static protected void unpack(int[] out, int[] in__, int bits) {
                switch (bits) {
                case 0:
                        unpack0(out, in__);
                        break;
        ...
        static private void unpack0(int[] out, int[] in__) {
        }

        static private void unpack1(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 1;
                for (i = 0, w = 1; i < 4; ++i, w += 1) {
                        int curInputValue0 = in__[w];
        ...
        static private void unpack2(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 3;
                for (i = 0, w = 1; i < 4; ++i, w += 2) {
                        int curInputValue0 = in__[w];
                        int curInputValue1 = in__[w + 1];
                        out[0 + outOffset] = curInputValue0 & mask;
        ...
        static private void unpack3(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 7;
        ...
        static private void unpack4(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 15;
        ...
        static private void unpack5(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 31;
        ...
        static private void unpack6(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 63;
        ...
        static private void unpack7(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 127;
        ...
        static private void unpack8(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 255;
        ...
        static private void unpack9(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 511;
        ...
        static private void unpack10(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 1023;
        ...
        static private void unpack11(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 2047;
        ...
        static private void unpack12(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 4095;
        ...
        static private void unpack13(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                final int mask = 8191;
        ...
        static private void unpack16(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                ...
                for (i = 0, w = 1; i < 4; ++i, w += 16) {
                        ...
                        int curInputValue11 = in__[w + 11];
                        int curInputValue12 = in__[w + 12];
                        int curInputValue13 = in__[w + 13];
                        int curInputValue14 = in__[w + 14];
                        int curInputValue15 = in__[w + 15];
                        out[0 + outOffset] = curInputValue0 & mask;
        ...
        static private void unpack20(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                ...
                for (i = 0, w = 1; i < 4; ++i, w += 20) {
                        ...
                        int curInputValue14 = in__[w + 14];
                        int curInputValue15 = in__[w + 15];
                        int curInputValue16 = in__[w + 16];
                        int curInputValue17 = in__[w + 17];
                        int curInputValue18 = in__[w + 18];
                        int curInputValue19 = in__[w + 19];
                        out[0 + outOffset] = curInputValue0 & mask;
        ...
        static private void unpack28(int[] out, int[] in__) {
                int i, w;
                int outOffset = 0;
                ...
                for (i = 0, w = 1; i < 4; ++i, w += 28) {
                        ...
                        int curInputValue18 = in__[w + 18];
                        int curInputValue19 = in__[w + 19];
                        int curInputValue20 = in__[w + 20];
                        int curInputValue21 = in__[w + 21];
                        int curInputValue22 = in__[w + 22];
                        int curInputValue23 = in__[w + 23];
                        int curInputValue24 = in__[w + 24];
                        int curInputValue25 = in__[w + 25];
                        int curInputValue26 = in__[w + 26];
                        int curInputValue27 = in__[w + 27];
                        out[0 + outOffset] = curInputValue0 & mask;
