...
public class PForDeltaUnpack128WIthIntBuffer {
        ...
        static protected void unpack(int[] out, IntBuffer in__, int bits) {
                switch (bits) {
                case 0:
                        unpack0(out, in__);
                        break;
        ...
        static private void unpack0(int[] out, IntBuffer in__) {
        }

        static private void unpack1(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 1;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
        ...
        static private void unpack2(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 3;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
                        int curInputValue1 = in__.get();
                        out[0 + outOffset] = curInputValue0 & mask;
        ...
        static private void unpack3(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 7;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
                        int curInputValue1 = in__.get();
                        int curInputValue2 = in__.get();
                        out[0 + outOffset] = curInputValue0 & mask;
        ...
        static private void unpack4(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 15;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
        ...
        static private void unpack5(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 31;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
        ...
        static private void unpack6(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 63;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
        ...
        static private void unpack7(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 127;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
        ...
        static private void unpack8(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 255;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
        ...
        static private void unpack9(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 511;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
        ...
        static private void unpack10(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 1023;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
        ...
        static private void unpack11(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 2047;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
        ...
        static private void unpack12(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 4095;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
        ...
        static private void unpack13(int[] out, IntBuffer in__) {
                int outOffset = 0;
                final int mask = 8191;
                for (int i = 0; i < 4; ++i) {
                        int curInputValue0 = in__.get();
        ...
        static private void unpack16(int[] out, IntBuffer in__) {
                int outOffset = 0;
                ...
                for (int i = 0; i < 4; ++i) {
                        ...
                        int curInputValue11 = in__.get();
                        int curInputValue12 = in__.get();
                        int curInputValue13 = in__.get();
                        int curInputValue14 = in__.get();
                        int curInputValue15 = in__.get();
                        out[0 + outOffset] = curInputValue0 & mask;
        ...
        static private void unpack20(int[] out, IntBuffer in__) {
                int outOffset = 0;
                ...
                for (int i = 0; i < 4; ++i) {
                        ...
                        int curInputValue14 = in__.get();
                        int curInputValue15 = in__.get();
                        int curInputValue16 = in__.get();
                        int curInputValue17 = in__.get();
                        int curInputValue18 = in__.get();
                        int curInputValue19 = in__.get();
                        out[0 + outOffset] = curInputValue0 & mask;
        ...
        static private void unpack28(int[] out, IntBuffer in__) {
                int outOffset = 0;
                ...
                for (int i = 0; i < 4; ++i) {
                        ...
                        int curInputValue18 = in__.get();
                        int curInputValue19 = in__.get();
                        int curInputValue20 = in__.get();
                        int curInputValue21 = in__.get();
                        int curInputValue22 = in__.get();
                        int curInputValue23 = in__.get();
                        int curInputValue24 = in__.get();
                        int curInputValue25 = in__.get();
                        int curInputValue26 = in__.get();
                        int curInputValue27 = in__.get();
                        out[0 + outOffset] = curInputValue0 & mask;
