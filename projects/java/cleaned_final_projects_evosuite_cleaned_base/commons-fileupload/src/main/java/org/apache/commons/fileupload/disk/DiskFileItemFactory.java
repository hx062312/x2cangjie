...
public class DiskFileItemFactory {
     ...
     */
    public DiskFileItemFactory(int sizeThreshold_param, File repository_param) {
     ...
     * @see #getRepository()
     */
    public void setRepository(File repository_param) {
        this.repository = repository_param;
    }
     ...
     */
    public void setSizeThreshold(int sizeThreshold_param) {
        this.sizeThreshold = sizeThreshold_param;
    }
