...
public abstract class FileUploadBase {
     ...
     * @see #getSizeMax()
     */
    public void setSizeMax(long sizeMax_param) {
        this.sizeMax = sizeMax_param;
    }
     ...
     */
    public void setFileSizeMax(long fileSizeMax_param) {
        this.fileSizeMax = fileSizeMax_param;
    }
     ...
     */
    public void setFileCountMax(final long fileCountMax_param) {
        this.fileCountMax = fileCountMax_param;
    }
     ...
     */
    private class FileUploadBase_FileItemIteratorImpl {

        /** Default implementation of {@link FileItemStream}. */
        class FileItemIteratorImpl_FileItemStreamImpl {
        ...
        private FileItemIteratorImpl_FileItemStreamImpl currentItem;
     ...
     * IOException}.
     */
    public static class FileUploadBase_FileUploadIOException extends IOException {
        ...
        /**
         * Creates a <code>FileUploadBase_FileUploadIOException</code> with the given cause.
         *
         * @param pCause The exceptions cause, if any, or null.
         */
        public FileUploadBase_FileUploadIOException(FileUploadException pCause) {
            cause = pCause;
        }
    ...
    public static class FileUploadBase_InvalidContentTypeException extends FileUploadException {

        /** The exceptions UID, for serializing an instance. */
        private static final long serialVersionUID_field = -9073026332015646668L;

        /** Constructs a <code>FileUploadBase_InvalidContentTypeException</code> with no detail message. */

        /**
         * Constructs an <code>FileUploadBase_InvalidContentTypeException</code> with the specified detail message.
         *
         ...
         * @since 1.3.1
         */
        public FileUploadBase_InvalidContentTypeException(String msg, Throwable cause_param) {
            super(msg, cause_param);
        }
    }

    /** Thrown to indicate an IOException. */
    public static class FileUploadBase_IOFileUploadException extends FileUploadException {

        /** The exceptions UID, for serializing an instance. */
        private static final long serialVersionUID_field = 1749796615868477269L;

        /**
         * The exceptions cause; we overwrite the parent classes field, which is available since
         * Java 1.4 only.
         */
        private final IOException cause_field;
         ...
         */
        public FileUploadBase_IOFileUploadException(String pMsg, IOException pException) {
            super(pMsg, null);
            cause_field = pException;
        }
    ...
    protected abstract static class FileUploadBase_SizeException extends FileUploadException {

        /** Serial version UID, being used, if serialized. */
        private static final long serialVersionUID_field = -8776225574705254126L;
         ...
         */
        protected FileUploadBase_SizeException(String message, long actual_param, long permitted_param) {
            super(message, null);
            this.actual = actual_param;
            this.permitted = permitted_param;
        }
     ...
     */
    @Deprecated
    public static class FileUploadBase_UnknownSizeException extends FileUploadException {

        /** The exceptions UID, for serializing an instance. */
        private static final long serialVersionUID_field = 7062279004812015273L;

        /** Constructs a <code>FileUploadBase_UnknownSizeException</code> with no detail message. */

        /**
         * Constructs an <code>FileUploadBase_UnknownSizeException</code> with the specified detail message.
         *
         * @param message The detail message.
         */
        public FileUploadBase_UnknownSizeException(String message) {
            super(message, null);
        }
    }

    /** Thrown to indicate that the request size exceeds the configured maximum. */
    public static class FileUploadBase_SizeLimitExceededException extends FileUploadBase_SizeException {

        /** The exceptions UID, for serializing an instance. */
        private static final long serialVersionUID_field = -2474893167098052828L;

        /**
         * @deprecated 1.2 Replaced by {@link #FileUploadBase_SizeLimitExceededException(String, long, long)}
         */
        @Deprecated
        public static FileUploadBase_SizeLimitExceededException SizeLimitExceededException0() {
            return new FileUploadBase_SizeLimitExceededException(null, 0, 0);
        }
         ...
         */
        @Deprecated
        public static FileUploadBase_SizeLimitExceededException SizeLimitExceededException1(String message) {
            return new FileUploadBase_SizeLimitExceededException(message, 0, 0);
        }
         ...
         */
        public FileUploadBase_SizeLimitExceededException(String message, long actual_param, long permitted_param) {
            super(message, actual_param, permitted_param);
        }
    }

    /** Thrown to indicate that A files size exceeds the configured maximum. */
    public static class FileUploadBase_FileSizeLimitExceededException extends FileUploadBase_SizeException {

        /** The exceptions UID, for serializing an instance. */
        private static final long serialVersionUID_field = 8150776562029630058L;
         ...
         * @param permitted The maximum permitted request size.
         */
        public FileUploadBase_FileSizeLimitExceededException(String message, long actual_param, long permitted_param) {
            super(message, actual_param, permitted_param);
        }
