...
public class DiskFileItem {
     ...
     */
    public DiskFileItem(
            String fieldName_param,
            String contentType_param,
            boolean isFormField_param,
            String fileName_param,
            int sizeThreshold_param,
            File repository_param) {
        this.fieldName = fieldName_param;
        this.contentType = contentType_param;
        this.isFormField = isFormField_param;
        this.fileName = fileName_param;
        this.sizeThreshold = sizeThreshold_param;
        this.repository = repository_param;
    }
     ...
     * @see #getFieldName()
     */
    public void setFieldName(String fieldName_param) {
        this.fieldName = fieldName_param;
    }
