...
public abstract class AbstractNumberValidator extends AbstractFormatValidator {
    ...
    private static final long serialVersionUID_field = -3088817875906765463L;
     ...
     *     integers only.
     */
    public AbstractNumberValidator(boolean strict_param, int formatType_param, boolean allowFractions_param) {
        super(strict_param);
        this.allowFractions = allowFractions_param;
        this.formatType = formatType_param;
    }
