...
public class ISINValidator implements Serializable {
     ...
     */
    public static ISINValidator getInstance(boolean checkCountryCode_param) {
        return checkCountryCode_param ? ISIN_VALIDATOR_TRUE : ISIN_VALIDATOR_FALSE;
    }

    private ISINValidator(boolean checkCountryCode_param) {
        this.checkCountryCode = checkCountryCode_param;
    }
