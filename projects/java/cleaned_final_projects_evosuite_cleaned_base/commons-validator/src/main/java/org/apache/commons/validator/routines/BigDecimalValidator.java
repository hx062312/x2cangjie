...
public class BigDecimalValidator extends AbstractNumberValidator {
    ...
    private static final long serialVersionUID_field = -670320911490506772L;
    ...
    protected BigDecimalValidator(boolean strict_param, int formatType_param, boolean allowFractions_param) {
        super(strict_param, formatType_param, allowFractions_param);
    }

    public static BigDecimalValidator BigDecimalValidator1(boolean strict_param) {
        return new BigDecimalValidator(strict_param, STANDARD_FORMAT, true);
    }
