...
import org.apache.commons.validator.routines.routines_CreditCardValidator;
import org.apache.commons.validator.routines.routines_DateValidator;
import org.apache.commons.validator.routines.routines_EmailValidator;
import org.apache.commons.validator.routines.routines_UrlValidator;
...
public class GenericValidator implements Serializable {
    ...
    /** routines_UrlValidator used in wrapper method. */
    private static final routines_UrlValidator URL_VALIDATOR = routines_UrlValidator.UrlValidator6();

    /** routines_CreditCardValidator used in wrapper method. */
    private static final routines_CreditCardValidator CREDIT_CARD_VALIDATOR =
            routines_CreditCardValidator.CreditCardValidator0();
    ...
    public static boolean isDate0(String value, Locale locale) {
        return routines_DateValidator.getInstance().isValid2(value, locale);
    }
    ...
    public static boolean isEmail(String value) {
        return routines_EmailValidator.getInstance0().isValid(value);
    }

    /**
     * Checks if a field is a valid url address. If you need to modify what is considered valid then
     * consider using the routines_UrlValidator directly.
     *
     * @param value The value validation is being performed on.
