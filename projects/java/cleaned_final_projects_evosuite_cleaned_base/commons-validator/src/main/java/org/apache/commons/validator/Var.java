...
public class Var implements Cloneable, Serializable {
     ...
     */
    public Var(int constructorId, String name_param, String value_param, String jsType_param) {
        super();
        if (constructorId == 1) {
            this.name = name_param;
            this.value = value_param;
            this.jsType = jsType_param;
        }
    }
     ...
     * @since Validator 1.2.0
     */
    public void setResource(boolean resource_param) {
     ...
     * @since Validator 1.2.0
     */
    public void setBundle(String bundle_param) {
        this.bundle = bundle_param;
    }
     ...
     */
    public void setJsType(String jsType_param) {
        this.jsType = jsType_param;
    }
