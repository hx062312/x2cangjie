...
public class Field {
     ...
     */
    public void setPage(int page_param) {
     ...
     */
    public void setFieldOrder(int fieldOrder_param) {
        this.fieldOrder = fieldOrder_param;
    }
     ...
     */
    public void setProperty(String property_param) {
        this.property = property_param;
    }
     ...
     */
    public void setIndexedProperty(String indexedProperty_param) {
        this.indexedProperty = indexedProperty_param;
    }
     ...
     */
    public void setIndexedListProperty(String indexedListProperty_param) {
        this.indexedListProperty = indexedListProperty_param;
    }
     ...
     */
    public void setDepends(String depends_param) {
        this.depends = depends_param;

        this.dependencyList.clear();

        StringTokenizer st = new StringTokenizer(depends_param, ",");
     ...
     * @since Validator 1.4
     */
    public void setClientValidation(boolean clientValidation_param) {
        this.clientValidation = clientValidation_param;
    }
     ...
     * @since Validator 1.1
     */
    public Arg getArg1(String key_param, int position) {
        if ((position >= this.args.length) || (this.args[position] == null)) {
            return null;
        }

        Arg arg = args[position].get(key_param);

        if ((arg == null) && key_param.equals(DEFAULT_ARG)) {
            return null;
        }
     ...
     */
    public Arg[] getArgs(String key_param) {
        Arg[] argList = new Arg[this.args.length];

        for (int i = 0; i < this.args.length; i++) {
            argList[i] = this.getArg1(key_param, i);
        }
