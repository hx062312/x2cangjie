...
public class BigIntegerValidator extends AbstractNumberValidator {
    ...
    private static final long serialVersionUID_field = 6713144356347139988L;
    ...
    public BigIntegerValidator(boolean strict_param, int formatType_param) {
        super(strict_param, formatType_param, false);
    }
