...
public final class CodeValidator implements Serializable {
    ...
    public CodeValidator(
            int constructorId,
            CheckDigit checkdigit_param,
            int maxLength_param,
            RegexValidator regexValidator_param,
            int minLength_param,
            String regex) {
        if (constructorId == 0) {
            this.regexValidator = regexValidator_param;
            this.minLength = minLength_param;
            this.maxLength = maxLength_param;
            this.checkdigit = checkdigit_param;
        } else {
    ...
    public static CodeValidator CodeValidator1(
            RegexValidator regexValidator_param, int length, CheckDigit checkdigit_param) {
        return new CodeValidator(0, checkdigit_param, length, regexValidator_param, length, null);
    }

    public static CodeValidator CodeValidator2(
            RegexValidator regexValidator_param, CheckDigit checkdigit_param) {
        return new CodeValidator(0, checkdigit_param, -1, regexValidator_param, -1, null);
    }

    public static CodeValidator CodeValidator4(String regex, int length, CheckDigit checkdigit_param) {
        return new CodeValidator(1, checkdigit_param, length, null, length, regex);
    }

    public static CodeValidator CodeValidator5(String regex, CheckDigit checkdigit_param) {
        return new CodeValidator(1, checkdigit_param, -1, null, -1, regex);
    }
