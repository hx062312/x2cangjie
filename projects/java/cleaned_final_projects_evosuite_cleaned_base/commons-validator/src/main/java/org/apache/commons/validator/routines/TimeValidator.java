...
public class TimeValidator extends AbstractCalendarValidator {
    ...
    private static final long serialVersionUID_field = 3494007492269691581L;
    ...
    public TimeValidator(boolean strict_param, int timeStyle_param) {
        super(strict_param, -1, timeStyle_param);
    }
