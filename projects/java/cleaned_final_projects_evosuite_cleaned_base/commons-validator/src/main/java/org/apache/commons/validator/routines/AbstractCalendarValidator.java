...
public abstract class AbstractCalendarValidator extends AbstractFormatValidator {
    ...
    private static final long serialVersionUID_field = -1410008585975827379L;
     ...
     */
    public AbstractCalendarValidator(boolean strict_param, int dateStyle_param, int timeStyle_param) {
        super(strict_param);
        this.dateStyle = dateStyle_param;
        this.timeStyle = timeStyle_param;
    }
