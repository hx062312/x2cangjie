 ...
 */
public class routines_DateValidator extends AbstractCalendarValidator {

    private static final long serialVersionUID_field = -3966328400469953190L;

    private static final routines_DateValidator VALIDATOR = routines_DateValidator.DateValidator1();

    /**
     * Return a singleton instance of this validator.
     *
     * @return A singleton instance of the routines_DateValidator.
     */
    public static routines_DateValidator getInstance() {
        return VALIDATOR;
    }

    /** Construct a <i>strict</i> instance with <i>short</i> date style. */
    public routines_DateValidator(boolean strict_param, int dateStyle_param) {
        super(strict_param, dateStyle_param, -1);
    }

    public static routines_DateValidator DateValidator1() {
        return new routines_DateValidator(true, DateFormat.SHORT);
    }
