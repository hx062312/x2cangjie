...
public class DoubleValidator extends AbstractNumberValidator {
    ...
    private static final long serialVersionUID_field = 5867946581318211330L;
    ...
    public DoubleValidator(boolean strict_param, int formatType_param) {
        super(strict_param, formatType_param, true);
    }
