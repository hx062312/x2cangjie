...
public class DomainValidator implements Serializable {
    ...
    private static class DomainValidator_LazyHolder { // IODH
    ...
    public static synchronized DomainValidator getInstance0() {
        inUse = true;
        return DomainValidator_LazyHolder.DOMAIN_VALIDATOR;
    }
     ...
     * @return the singleton instance of this validator
     */
    public static synchronized DomainValidator getInstance1(boolean allowLocal_param) {
        inUse = true;
        if (allowLocal_param) {
            return DomainValidator_LazyHolder.DOMAIN_VALIDATOR_WITH_LOCAL;
        }
        return DomainValidator_LazyHolder.DOMAIN_VALIDATOR;
    }

    /**
     * Returns a new instance of this validator. The user can provide a list of {@link DomainValidator_Item} entries
     ...
     *
     * @param allowLocal Should local addresses be considered valid?
     * @param items - array of {@link DomainValidator_Item} entries
     * @return an instance of this validator
     * @since 1.7
     */
    public static synchronized DomainValidator getInstance2(boolean allowLocal_param, List<DomainValidator_Item> items) {
        inUse = true;
        return new DomainValidator(0, items, allowLocal_param);
    }
    ...
    /** Private constructor. */
    public DomainValidator(int constructorId, List<DomainValidator_Item> items, boolean allowLocal_param) {
        if (constructorId == 0) {

            this.allowLocal = allowLocal_param;
            ...
            for (DomainValidator_Item item : items) {
    ...
    public boolean isValid(String domain) {
        ...
        String[] groups = domainRegex.match_(domain);
     ...
     * @since 1.7
     */
    public static class DomainValidator_Item {
        final ArrayType type__;
        final String[] values;
         ...
         */
        public DomainValidator_Item(ArrayType type___param, String[] values_param) {
            this.type__ = type___param;
            this.values = values_param; // no need to copy here
        }
    }
    ...
    static String unicodeToASCII(String input) {
        ...
        try {
            ...
            if (DomainValidator_IDNBUGHOLDER.IDN_TOASCII_PRESERVES_TRAILING_DOTS) {
                return ascii;
            }
    ...
    private static class DomainValidator_IDNBUGHOLDER {
