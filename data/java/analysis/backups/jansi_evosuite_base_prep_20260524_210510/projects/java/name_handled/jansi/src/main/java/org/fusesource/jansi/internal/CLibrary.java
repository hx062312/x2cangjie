...
public class CLibrary {
    ...
    public static native int tcsetattr(int filedes, int optional_actions, CLibrary_Termios termios);
    ...
    public static native int ioctl(int filedes, long request, CLibrary_WinSize params);
     ...
     */
    public static class CLibrary_WinSize {
     ...
     */
    public static class CLibrary_Termios {
