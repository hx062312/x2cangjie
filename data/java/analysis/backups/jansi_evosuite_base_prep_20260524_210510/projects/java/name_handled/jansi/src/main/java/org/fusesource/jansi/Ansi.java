...
public class Ansi implements Appendable {
    ...
    @FunctionalInterface
    public interface Ansi_Consumer {
    ...
    public static Ansi ansi(int size) {
        if (isEnabled()) {
            ...
            return new Ansi_NoAnsi(size);
        }
    }

    private static class Ansi_NoAnsi extends Ansi {
        public Ansi_NoAnsi() {
            super();
        }

        public Ansi_NoAnsi(int size) {
            super(size);
        }

        public Ansi_NoAnsi(StringBuilder builder) {
            super(builder);
        }
     ...
     * @since 2.2
     */
    public Ansi apply(Ansi_Consumer fun) {
        fun.apply(this);
        return this;
    }
